...
clear 
odbc load, exec("SELECT * FROM .ccu024_01_cohort_deaths") dsn("databricks")
/*deaths from 2018-2020*/
sort PERSON_ID
save "$raw/deaths_2018_2020.dta", replace

clear
odbc load, exec("SELECT * FROM .ccu024_01_cohort_hes_ae") dsn("databricks")
...
clear
odbc load, exec("SELECT * FROM .ccu024_01_skinny_deaths") dsn("databricks")
/*linked in demogs*/
sort PERSON_ID
